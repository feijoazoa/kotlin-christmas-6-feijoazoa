...
class InputView {
    ...
    companion object
    {
        ...
        private const val REQUEST_MENU_ORDER_MESSAGE = "주문할 메뉴와 개수를 입력해주세요 (e.g. 해산물파스타-2,레드와인-1,초코케이크-1)"
        private const val INVALID_DATE_INPUT_ERROR = "[ERROR] 유효하지 않은 날짜입니다. 다시 입력해 주세요."
        private const val INVALID_ORDER_INPUT_ERROR = "[ERROR] 유효하지 않은 주문입니다. 다시 입력해 주세요."
    }
}
